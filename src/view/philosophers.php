    ...
    <main class="philosophers-page">
        ...
        <div class="philosophers__info-card" id="philosophersInfoCard" role="dialog" aria-hidden="true">
            ...
            <p class="philosophers__info-card-text">
                Todos os textos foram elaborados com base em fontes públicas disponíveis na internet, com apoio de
                inteligência artificial.
                <br>
                As imagens dos filósofos foram obtidas a partir de fontes públicas disponíveis online e são utilizadas
                exclusivamente para fins educativos e informativos.
                <br>
                Caso seja identificado qualquer erro, informação desatualizada ou eventual questão relacionada aos
                direitos de uso de textos ou imagens, entre em contato para que o conteúdo seja analisado e, se
                necessário, corrigido ou removido o mais breve possível.
            </p>
        </div>
        ...
        <div class="philosophers-accordion" data-philosophers-accordion>
                    ...
                    <div class="philosophers-category__body">
                        ...
                        <ul class="philosophers-list">
                            <li class="philosophers-list__item">
                                <a class="philosophers-list__link" href="/philosophers/tales-de-mileto">
                                    <img class="philosophers-list__image"
                                        data-src="/assets/images/philosophers/Tales.webp" alt="Tales de Mileto">
                                    <h3 class="philosophers-list__name">Tales de Mileto</h3>
                            ...
                            <li class="philosophers-list__item">
                                <a class="philosophers-list__link" href="/philosophers/zenao-de-eleia">
                                    <img class="philosophers-list__image"
                                        data-src="/assets/images/philosophers/ZenaoEleia.webp" alt="Zenão de Eleia">
            ...
            <div class="philosophers-category" data-philosophers-item>
                ...
                <div class="philosophers-category__panel" data-philosophers-panel>
                    <div class="philosophers-category__body">
                        <img class="philosophers-category__image"
                            data-src="/assets/images/philosophers/banner/Medievais.webp" alt="">
                        <p class="philosophers-category__description">
            ...
            <div class="philosophers-category" data-philosophers-item>
                ...
                <div class="philosophers-category__panel" data-philosophers-panel>
                    <div class="philosophers-category__body">
                        <img class="philosophers-category__image"
                            data-src="/assets/images/philosophers/banner/Modernos.webp" alt="Banner Modernos">
                        <p class="philosophers-category__description">
            ...
            <div class="philosophers-category" data-philosophers-item>
                ...
                <div class="philosophers-category__panel" data-philosophers-panel>
                    <div class="philosophers-category__body">
                        <img class="philosophers-category__image"
                            data-src="/assets/images/philosophers/banner/Contemporaneos.webp"
                            alt="Banner Conteporaneos">
                        <p class="philosophers-category__description">
